    ...
    siteConfig: {
      ...
      appSettings: [
        ...
        }
        {
          ...
          value: '@Microsoft.KeyVault(VaultName=${keyVault.name};SecretName=${apiManagement.name}-app-geolocation-web-${parEnvironment}-${parInstance}-${varEnvironmentUniqueId}-geolocation-subscription-apikey)'
        }
        {
