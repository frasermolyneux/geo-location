...
public class GeoLookupApiTests : IDisposable
{
    ...
    private GeoLocationApiClientOptions validGeoLocationApiClientOptions => new()
    {
    ...
    public async Task GetGeoLocationShouldPassThroughApiResponse()
    {
        ...
        mockRestClientService.Setup(x => x.ExecuteAsync(It.IsAny<string>(), It.IsAny<RestRequest>(), default))
