...
{
    /// <summary>
    /// GeoLocation result from MaxMind City lookup with typed network traits
    /// and subdivision data.
    /// </summary>
    public record CityGeoLocationDto
    {
        [JsonProperty]
        ...
        [JsonProperty]
        public NetworkTraitsDto NetworkTraits { get; internal set; } = new();
    }
}
